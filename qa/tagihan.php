<?php  
	...
	if (isset($_POST['bcari_text'])) {
		$text = $_POST['tcari'];
		$cari = "WHERE id_pelanggan LIKE '%$text%' OR bulan LIKE '%$text%' OR tahun LIKE '%$text%' OR jumlah_meter LIKE '%$text%' OR tarif_perkwh LIKE '%$text%' OR jumlah_bayar LIKE '%$text%' OR nama_mgr LIKE '%$text%' OR nama_pelanggan LIKE '%$text%' OR status LIKE '%$text%'";
	}
						...
						<form method="post">
							<div class="col-md-12">
								<div class="col-md-7 pull-left">
									<label>Filter Data Tagihan Perbulan</label>
...
<!--								<div class="col-md-5 pull-right">
									<label style="color: black;font-family: Myriad Pro Light">Filter Data Melalui Pencarian</label>
									<div class="input-group">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover">
									...
									<tbody>
										<?php  
											$no=0;
											$a = $aksi->tampil("v_tagihan",$cari,"ORDER BY status ASC");
											if (empty($a)) {
												$aksi->no_record(8);
											}else{
												foreach ($a as $r) {
